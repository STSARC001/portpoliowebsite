    ...
    >
      ...
      <Link href="/summary">
        ...
        >
          ...
          <p className="text-xs text-gray-500 mt-2">AI-driven solutions and innovation portfolio</p>
        </motion.div>
      </Link>
      ...
      <Link href="/experience">
        ...
        >
          ...
          <p className="text-xs text-gray-500 mt-2">Leading innovative teams across technology frontiers</p>
        </motion.div>
      </Link>
